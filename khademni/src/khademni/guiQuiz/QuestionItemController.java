...
public class QuestionItemController implements Initializable {
    ...
    public QuestionItemController(){
    
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/khademni/guiQuiz/QuestionItem.fxml"));
